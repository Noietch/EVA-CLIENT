...
class ArxX5(Robot):
    ...
    # Neutral collection pose used by the console scene for both symmetric arms.
    ...
    def build_kinematics(self, **kwargs: Any) -> Any:
        if _PYROKI_IMPORT_ERROR is not None:
            raise ImportError("ARX X5 kinematics requires the PyRoki/JAX dependencies") from (
