...
class CalibrateSession:
    ...
    attach_links: dict[str, str] = dataclasses.field(default_factory=dict)
    active: bool = False
    ...
    last_error: str = ""
    saved_path: str = ""
    poses: list[list[float]] = dataclasses.field(default_factory=list)
    current_pose_index: int = -1  # -1 = none selected
    pose_capture_state: list[bool] = dataclasses.field(default_factory=list)
