...
import { handleCollectionReviewInput, resetCollectionReviewInput, changeCollectionExportFormat, changeCollectionSlotFilter, changeCollectionSlotPage, clearReviewPlayback, collectConfigured, exportCollectionQuality, installCollectKeyboardControls, pollEpisodeHistory, renderCollect, renderCollectControls, renderRolloutSave, returnReviewToLive, reviewActiveInCurrentTab, saveAnnotation, startCollectFromTab, submitEpisodeNote, submitEpisodeQc, submitQc, syncAssetsToHf, syncCollectionQc, syncTaskSetFromHf, toggleCollectionSlotAll, uploadCollectionDatasetToHf, downloadCollectionDatasetFromHf, uploadCollectionQuality } from "./collect.js";
...
$("b-collect-task-set-sync").onclick = syncTaskSetFromHf;
$("b-collect-assets-sync").onclick = syncAssetsToHf;
$("b-collect-dataset-upload").onclick = uploadCollectionDatasetToHf;
$("b-collect-dataset-download").onclick = downloadCollectionDatasetFromHf;
$("b-collect-qc-upload").onclick = () => syncCollectionQc("upload");
$("b-collect-qc-download").onclick = () => syncCollectionQc("download");
