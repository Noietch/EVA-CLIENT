...
import { handleCollectionReviewInput, resetCollectionReviewInput, changeCollectionExportFormat, changeCollectionSlotFilter, changeCollectionSlotPage, clearReviewPlayback, collectConfigured, exportCollectionQuality, installCollectKeyboardControls, pollEpisodeHistory, renderCollect, renderCollectControls, renderRolloutSave, returnReviewToLive, reviewActiveInCurrentTab, saveAnnotation, startCollectFromTab, submitEpisodeNote, submitEpisodeQc, submitQc, downloadAssetsFromHf, syncCollectionQc, syncTaskSetFromHf, toggleCollectionSlotAll, uploadCollectionDatasetToHf, downloadCollectionDatasetFromHf, uploadCollectionQuality } from "./collect.js";
...
$("b-collect-assets-sync").onclick = downloadAssetsFromHf;
