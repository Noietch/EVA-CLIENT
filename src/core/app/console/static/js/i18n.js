...
const GLOSSARY = {
  ...
  "collect.controlOff": ["待启用", "ARM OFF"],
  "collect.controlWaiting": ["待授权", "AWAIT GRIP"],
  ...
  "teleop.arm.left.off": ["左臂待启用", "LEFT ARM OFF"],
  "teleop.arm.left.awaiting": ["左臂待授权", "LEFT ARM AWAIT GRIP"],
  ...
  "teleop.arm.right.off": ["右臂待启用", "RIGHT ARM OFF"],
  "teleop.arm.right.awaiting": ["右臂待授权", "RIGHT ARM AWAIT GRIP"],
