...
node_args=(
  ...
  --gripper-kp "${YAM_GRIPPER_KP:-5.0}"
  --gripper-damping "${YAM_GRIPPER_DAMPING:-0.5}"
  --gripper-close-torque-limit "${YAM_GRIPPER_CLOSE_TORQUE_LIMIT:-0.29}"
  --gripper-open-torque-limit "${YAM_GRIPPER_OPEN_TORQUE_LIMIT:-0.29}"
  --gripper-max-speed "${YAM_GRIPPER_MAX_SPEED:-1.0}"
