...
class BimanualArm:
        ...
        **kwargs
        ...
        if "left" in positions:
            self.left_arm.set_joint_positions(
                positions["left"],
                joint_names=joint_names.get("left") if joint_names else None,
                **kwargs
            )
        if "right" in positions:
            self.right_arm.set_joint_positions(
                positions["right"],
                joint_names=joint_names.get("right") if joint_names else None,
                **kwargs
            )
    ...
    def set_ee_pose_xyzrpy(
        self,
        xyzrpy: Dict[str, Union[List[float], np.ndarray]],
        **kwargs
    ) -> Dict[str, bool]:
        """
        ...
        result = {}
        if "left" in xyzrpy:
            result["left"] = self.left_arm.set_ee_pose_xyzrpy(xyzrpy["left"], **kwargs)

        if "right" in xyzrpy:
            result["right"] = self.right_arm.set_ee_pose_xyzrpy(xyzrpy["right"], **kwargs)
    ...
    def set_ee_pose_rpy(
        ...
        **kwargs
        ...
        return self.set_ee_pose_xyzrpy(xyzrpy, **kwargs)
