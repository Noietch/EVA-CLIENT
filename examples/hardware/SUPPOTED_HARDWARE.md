...
| ARX X5 | WebXR / handheld controller | `left_arm=left`, `right_arm=right` | `configs/02_collection/arx_x5_vr.py`, `configs/02_collection/arx_x5_vr_tasks_set.py`, `configs/04_rl/arx_x5_rl.py` | VR teleop; no physical leader adapter is wired in the hardware node. |
