            ...
            [
                ...
                json.dumps(
                    [
                        ...
                        {"object_id": "AST-001", "position_ids": ["P3"], "random": True},
                    ]
                ),
            ]
        )
...
def test_scene_placements_reject_invalid_explicit_random():
    placements = [{"object_id": "cup", "position_ids": ["P1"], "random": "false"}]
