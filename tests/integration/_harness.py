...
_DEFAULTS_PATH = Path(__file__).resolve().parents[2] / "configs" / "00_base" / "defaults.py"
...
def console_config(**overrides: Any) -> ConfigDict:
    ...
    # Collection data must never land in the repository's shared data root.
    cfg.collection.storage.data_root = tempfile.mkdtemp(prefix="eva-test-data-")
