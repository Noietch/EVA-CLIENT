...
def test_run_hardware_starts_r1lite_and_cat_through_eva_hil_bootstrap():
    ...
    assert 'R1LITE_HOST="${R1LITE_HOST:-r1lite@<R1LITE_HOST>}"' in script
    assert 'CAT_HOST="${CAT_HOST:-cat@<CAT_HOST>}"' in script
    assert (
    ...
    assert 'CAT_ROS2_LOCAL_IP="${CAT_ROS2_LOCAL_IP:-<CAT_IP>}"' in script
    assert 'R1LITE_DISCOVERY_SERVER_IP="${R1LITE_DISCOVERY_SERVER_IP:-<R1LITE_IP>}"' in script
